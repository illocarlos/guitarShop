...
<!-- -------- -->
      ...
      <main class="container-xl mt-5">
          ...
          <div class="row mt-5">
              ...
              <div class="col-md-6 col-lg-4 my-4 row align-items-center ">
                  <div class="col-4 guitar-rigth-block-two">
                      <img class="img-fluid" src="/img/guitarra_04.jpg" alt="imagen guitarra">
                  </div>
                  <div class="col-8 guitar-rigth-block-two">
              ...
              <div class="col-md-6 col-lg-4 my-4 row align-items-center">
                  <div class="col-4 guitar-rigth-block-three ">
                      <img class="img-fluid" src="/img/guitarra_07.jpg" alt="imagen guitarra">
                  </div>
                  <div class="col-8 guitar-rigth-block-three">
              ...
              <div class="col-md-6 col-lg-4 my-4 row align-items-center">
                  <div class="col-4 guitar-rigth-block-four">
                      <img class="img-fluid" src="/img/guitarra_10.jpg" alt="imagen guitarra">
                  </div>
                  <div class="col-8 guitar-rigth-block-four">
